...
public class dld extends AppCompatActivity implements DownloadFile.Listener {

    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1MebKtC5WeqAd3jxQoYbBoenoS5EZyqYn";
    LinearLayout root;
