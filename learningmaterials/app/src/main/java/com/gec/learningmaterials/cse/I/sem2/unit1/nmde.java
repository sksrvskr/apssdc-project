package com.gec.learningmaterials.cse.I.sem2.unit1;
...
public class nmde extends AppCompatActivity  implements  DownloadFile.Listener{
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1s4yvkzcAyDKWfYnVgPuVo-htLlL5uAgN";
    LinearLayout root;
