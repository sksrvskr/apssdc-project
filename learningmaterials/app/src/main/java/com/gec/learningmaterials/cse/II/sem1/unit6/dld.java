package com.gec.learningmaterials.cse.II.sem1.unit6;
...
public class dld extends AppCompatActivity implements DownloadFile.Listener {
    ...
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=10EEGWhZ6mwipJpnOE29nvcwcmT85vuSY";
    LinearLayout root;
