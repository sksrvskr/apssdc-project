package com.gec.learningmaterials.cse;
...
public class csey extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        I.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.cse.I.sem.class);
                startActivity(i);
     ...
     IV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(),com.gec.learningmaterials.cse.II.sem.class);
                startActivity(i);
        ...
        V.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.cse.III.sem.class);
                startActivity(i);
        ...
        VIII.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.cse.IV.sem.class);
                startActivity(i);
