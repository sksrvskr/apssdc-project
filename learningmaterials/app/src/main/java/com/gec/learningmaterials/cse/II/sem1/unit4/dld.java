package com.gec.learningmaterials.cse.II.sem1.unit4;
...
public class dld extends AppCompatActivity implements DownloadFile.Listener {
    ...
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=11VO_22dATg_mNtx0KuDNeKIDmnGv3A3X";
    LinearLayout root;
