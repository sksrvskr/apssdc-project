package com.gec.learningmaterials.cse.II.sem1.unit3;
...
public class dld extends AppCompatActivity implements DownloadFile.Listener {
    ...
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=18H3xvG7GjDbtqnvYOZTf1Dd3itqZw8AX";
    LinearLayout root;
