package com.gec.learningmaterials.cse.I.sem2.unit6;
...
public class nmde extends AppCompatActivity  implements  DownloadFile.Listener{
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1wxrestq9s-P4RgZ63tUQreoZbHEWuFOz";
    LinearLayout root;
