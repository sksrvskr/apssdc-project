package com.gec.learningmaterials.cse.I.sem2.unit5;
...
public class nmde extends AppCompatActivity  implements  DownloadFile.Listener{
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1xaa-sx_mIy8EBMBQm1d7v10VQztvNsxx";
    LinearLayout root;
