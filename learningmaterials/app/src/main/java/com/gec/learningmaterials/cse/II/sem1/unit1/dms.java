...
public class dms extends AppCompatActivity implements DownloadFile.Listener {

    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1ZasTZzqMsmiNs0_NHSAuP9IskX5OYuce";
    LinearLayout root;
