package com.gec.learningmaterials.civil;
...
public class civily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        I.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.civil.I.sem.class);
                startActivity(i);
        ...
        IV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(),com.gec.learningmaterials.civil.II.sem.class);
                startActivity(i);
        ...
        V.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.civil.III.sem.class);
                startActivity(i);
        ...
        VIII.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), com.gec.learningmaterials.civil.IV.sem.class);
                startActivity(i);
