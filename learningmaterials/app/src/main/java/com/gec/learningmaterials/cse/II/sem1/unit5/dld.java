package com.gec.learningmaterials.cse.II.sem1.unit5;
...
public class dld extends AppCompatActivity implements DownloadFile.Listener {
    ...
    private  final  String pdflink = "https://drive.google.com/uc?export=download&id=1JeCwi-enVCeZ4EMvuhAFTr7VbMnCRUie";
    LinearLayout root;
